...
class Reference: ObservableObject {
    ...
    init() {
        ...
        currentThemeIndex = 0
        for _ in projects[currentProjectIndex].themes
        {
//            projects[currentProjectIndex].themes[currentThemeIndex].color = Color(themeColors[currentThemeIndex])
            
            projects[currentProjectIndex].themes[currentThemeIndex].color = (colorScheme == .dark ? Colors().pLight[currentThemeIndex] : Colors().pDark[currentThemeIndex])
            
            //.opacity(0.3)
            
            currentStoryIndex = 0
            for _ in projects[currentProjectIndex].themes[currentThemeIndex].stories
            {
                projects[currentProjectIndex].themes[currentThemeIndex].stories[currentStoryIndex].color = (colorScheme == .dark ? Colors().pLight[currentThemeIndex] : Colors().pDark[currentThemeIndex])
                //.opacity(0.3)
        ...
        for _ in projects[currentProjectIndex].themes
        {
            projects[currentProjectIndex].themes[currentThemeIndex].color = (colorScheme == .dark ? Colors().vLight[currentThemeIndex] : Colors().vDark[currentThemeIndex])
            //.opacity(0.3)
            
            currentStoryIndex = 0
            for _ in projects[currentProjectIndex].themes[currentThemeIndex].stories
            {
                projects[currentProjectIndex].themes[currentThemeIndex].stories[currentStoryIndex].color = (colorScheme == .dark ? Colors().vLight[currentThemeIndex] : Colors().vDark[currentThemeIndex])
                //.opacity(0.3)
    ...
    @Published var projects = [
        Project(id: 1, title: "Book 1", themes: [
                    iTheme(id: 1, image: "book.fill", name: "facilisis magna etiam", description: "Elit scelerisque mauris pellentesque pulvinar pellentesque habitant. Nunc lobortis mattis aliquam faucibus purus in massa tempor. Molestie at elementum eu facilisis sed. Velit euismod in pellentesque massa. Commodo nulla facilisi nullam vehicula ipsum a arcu cursus vitae. Amet facilisis magna etiam tempor orci eu lobortis elementum nibh. Arcu dictum varius duis at consectetur lorem donec. Aenean pharetra magna ac placerat. Posuere urna nec tincidunt praesent semper feugiat nibh sed pulvinar. Sed egestas egestas fringilla phasellus faucibus scelerisque eleifend. Vitae justo eget magna fermentum. Ut sem viverra aliquet eget. Orci nulla pellentesque dignissim enim sit amet venenatis urna. Libero nunc consequat interdum varius sit amet mattis vulputate enim. Suspendisse interdum consectetur libero id faucibus nisl. Tellus molestie nunc non blandit massa enim nec. Amet aliquam id diam maecenas ultricies. Praesent tristique magna sit amet purus gravida quis blandit turpis.", numberOfUsers: 5, numberOfStories: 22, color: Color(UIColor.systemGray2), stories: [
                            iStory(id: 1,
                                   icon: "person.fill",
                                   role: "Donec Ultrices",
        ...
        Project(id: 2, title: "Book 2", themes: [
                    iTheme(id: 1, image: "book.fill", name: "facilisis magna etiam", description: "Elit scelerisque mauris pellentesque pulvinar pellentesque habitant. Nunc lobortis mattis aliquam faucibus purus in massa tempor. Molestie at elementum eu facilisis sed. Velit euismod in pellentesque massa. Commodo nulla facilisi nullam vehicula ipsum a arcu cursus vitae. Amet facilisis magna etiam tempor orci eu lobortis elementum nibh. Arcu dictum varius duis at consectetur lorem donec. Aenean pharetra magna ac placerat. Posuere urna nec tincidunt praesent semper feugiat nibh sed pulvinar. Sed egestas egestas fringilla phasellus faucibus scelerisque eleifend. Vitae justo eget magna fermentum. Ut sem viverra aliquet eget. Orci nulla pellentesque dignissim enim sit amet venenatis urna. Libero nunc consequat interdum varius sit amet mattis vulputate enim. Suspendisse interdum consectetur libero id faucibus nisl. Tellus molestie nunc non blandit massa enim nec. Amet aliquam id diam maecenas ultricies. Praesent tristique magna sit amet purus gravida quis blandit turpis.", numberOfUsers: 5, numberOfStories: 22, color: Color(UIColor.systemGray2), stories: [
                            iStory(id: 1,
                                   icon: "person.fill",
                                   role: "Donec Ultrices",
    ...
    var themes: [iTheme] {
        return projects[referenceProjectID - 1].themes
    }
    
    var stories: [iStory] {
        return projects[referenceProjectID - 1].themes[referenceThemeID - 1].stories
    }
    
    
    var referenceProjectID = 1
    var referenceThemeID = 1
    var referenceStoryID = 1
    
    func addProject(title: String) {
        let newProjectID = referenceProjectID + 1 // New projct ID is number or projects plus 1
        let newProject = Project(id: newProjectID, title: title, themes: []) // Initialize new project with title and no themes
        projects.append(newProject) // add new project to current projects
    }
    
    func addTheme(image: String, name: String, description: String, color: Color)
    {
        let newThemeID = projects[referenceProjectID - 1].themes.count + 1 // Theme ID is
        let newTheme = iTheme(id: newThemeID, image: image, name: name, description: description, numberOfUsers: 0, numberOfStories: 0, color: color, stories: [], projectId: referenceProjectID)
        projects[referenceProjectID - 1].themes.append(newTheme)
    }
    
    func readTheme(inputThemeId: Int) -> iTheme
    {
        let themes = projects[referenceProjectID - 1].themes
        var readIndex = 0
        var count = 0
        
        for currentTheme in themes
        {
            if currentTheme.id == inputThemeId
            {
                readIndex = count
            }
        ...
        //var deleteLocation = projects[projectID - 1].themes[themeID - 1].stories[1].id
        
        return projects[referenceProjectID - 1].themes[readIndex]
    }
    
    func addStory(image: String, role: String, description: String, date: String, priority: String, details: String, color: Color?)
    {
        
        let projectCurrent = projects[referenceProjectID - 1]
        let themeCurrent = projectCurrent.themes[referenceThemeID-1]
        let storiesCurrent = themeCurrent.stories
        
        let newStoryID = storiesCurrent.count + 1
        
        //let newStoryID = projects[projectID - 1].themes[themeID-1].stories.count + 1
//        let newStory = iStory(id: newStoryID, icon: image, role: role, description: description, date: date, priority: priority, details: details, color: themes[referenceThemeID-1].color, themeId: referenceThemeID)
        let newStory = iStory(id: newStoryID, icon: image, role: role, description: description, date: date, priority: priority, details: details, color: themeCurrent.color, themeId: referenceThemeID)
        projects[referenceProjectID - 1].themes[referenceThemeID - 1].stories.append(newStory)
    }
    
    func deleteStory(storyIdToRemove: Int)
    {
        var stories = projects[referenceProjectID - 1].themes[referenceThemeID - 1].stories
        var removeIndex = 0
        var count = 0
        
        print("story id to remove is \(storyIdToRemove)")
        
        for currentStory in stories
        {
        ...
        projects[referenceProjectID - 1].themes[referenceThemeID - 1].stories.remove(at: removeIndex)
        
    }
    
    func readStory(storyIdToRead: Int) -> iStory
    {
        let stories = projects[referenceProjectID - 1].themes[referenceThemeID - 1].stories
        var readIndex = 0
        var count = 0
        
        print("story id to read is \(storyIdToRead)")
        
        for currentStory in stories
        {
            if currentStory.id == storyIdToRead
            {
                readIndex = count
            }
        ...
        return projects[referenceProjectID - 1].themes[referenceThemeID - 1].stories[readIndex]
        
    }
    
    //    func deleteStory(projectID: Int, themeID: Int, storyID: Int)
    //    {
    //        print("In theme \(themeID)")
    //        print("Deleting story \(storyID)")
    //        //projects[projectID - 1].themes[themeID - 1].stories[storyID]
    //        //projects[projectID - 1].themes[themeID - 1].stories.remove(atOffsets: storyID)
    //
    //    }
    
    func totalThemes(for project: Project) -> String {
        return "\(project.themes.count) theme\(project.themes.count == 1 ? "" : "s")"
    }
    
    func totalStories(for theme: iTheme) -> String {
        //return "\(theme.stories.count) story\(theme.stories.count == 1 ? "" : "s")"
        return "\(theme.stories.count)"
        //        return theme.stories.count
    }
    
    func totalStoriesInt(for theme: iTheme) -> Int {
        //return "\(theme.stories.count) story\(theme.stories.count == 1 ? "" : "s")"
        return theme.stories.count
        //        return theme.stories.count
    }
