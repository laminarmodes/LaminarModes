//
//  GlassmorphicColorCarousels.swift
//  LaminarModes
//
...
struct GlassmorphicColorCarousels: View {
...
struct GlassmorphicColorCarousels_Previews: PreviewProvider {
    static var previews: some View {
        GlassmorphicColorCarousels(libraryID: Reference().libraries[0].uniqueID).environmentObject(Reference())
    }
}
